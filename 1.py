...
if __name__ == "__main__":
    ...
    imsave(r'o\defaults.png', defaults)
    imsave(r'o\landmarks.png', landmarks)
    imsave(r'o\abstract.png', abstract)
    imsave(r'o\more_detail.png', more_detail)
    imsave(r'o\less_detail.png', less_detail)
    imsave(r'o\smoother.png', smoother)
    imsave(r'o\aa.png', aa)